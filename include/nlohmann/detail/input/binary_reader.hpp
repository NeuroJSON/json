  ...
  private:
    ...
    bool get_ubjson_string(string_t& result, const bool get_char = true)
    {
        ...
        switch (current)
        {
            ...
            default:
                ...
                auto last_token = get_token_string();
                return sax->parse_error(chars_read, last_token, parse_error::create(113, chars_read, exception_message(format, "expected length type specification (U, i, I, l, L); last byte: 0x" + last_token, "string"), BasicJsonType()));
        }
    }
    ...
    bool get_ubjson_size_value(std::size_t& result, int prefix = 0)
    {
        ...
        switch (prefix)
        {
            ...
            default:
            {
                ...
                auto last_token = get_token_string();
                return sax->parse_error(chars_read, last_token, parse_error::create(113, chars_read, exception_message(format, "expected length type specification (U, i, I, l, L) after '#'; last byte: 0x" + last_token, "size"), BasicJsonType()));
            }
        }
    }
    ...
    bool get_ubjson_size_type(std::pair<std::size_t, char_int_type>& result)
    {
        ...
        if (current == '$')
        {
            ...
            if (JSON_HEDLEY_UNLIKELY(current != '#'))
            {
                ...
                auto last_token = get_token_string();
                return sax->parse_error(chars_read, last_token, parse_error::create(112, chars_read, exception_message(format, "expected '#' after type information; last byte: 0x" + last_token, "size"), BasicJsonType()));
            }
    ...
    bool get_ubjson_value(const char_int_type prefix)
    {
        switch (prefix)
        {
            ...
            case 'C':  // char
            {
                ...
                {
                    auto last_token = get_token_string();
                    return sax->parse_error(chars_read, last_token, parse_error::create(113, chars_read, exception_message(format, "byte after 'C' must be in range 0x00..0x7F; last byte: 0x" + last_token, "char"), BasicJsonType()));
                }
            ...
            default: // anything else
            {
                ...
                auto last_token = get_token_string();
                return sax->parse_error(chars_read, last_token, parse_error::create(112, chars_read, exception_message(format, "invalid byte: 0x" + last_token, "value"), BasicJsonType()));
            }
        }
    }
    ...
    */
    ...
    bool get_ubjson_high_precision_number()
    {
        ...
        {
            return sax->parse_error(chars_read, number_string, parse_error::create(115, chars_read, exception_message(format, "invalid number text: " + number_lexer.get_token_string(), "high-precision number"), BasicJsonType()));
        }
